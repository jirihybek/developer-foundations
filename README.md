...
- [Topics You Should Know as a Developer](./Learning-Topics.md)
- [Workbook](./workbook/README.md)
- [Projects](./projects/README.md)
- [Best Practices](./Best-Practices.md)
- [My Learning Plan](./My-Plan.md)
...
If you are not using VS Code, check out [Learning Assistant Agent](.github/agents/Learning%20Assistant.agent.md) as an inspiration to create a similar agent in your AI tool of choice or configure prompt in ChatGPT or other chat-based AI.
...
1. Read the topics you should know as a developer in the [Topics You Should Know as a Developer](./Learning-Topics.md) file.
2. Pick a topic you want to start with and open the corresponding file in the [workbook](./workbook/README.md) folder.
...
5. Once done, mark the topic as completed in the [Topics You Should Know as a Developer](./Learning-Topics.md) file.

> **TIP:** Write your own learning plan into [My-Plan.md](./My-Plan.md) based on the checklist in [Topics You Should Know as a Developer](./Learning-Topics.md). Identify which topics you want to focus on first, set goals for each topic, and outline your study schedule.

## Projects

In the [projects](./projects/README.md) folder, you can find small projects that you can build to practice your skills. Each project contains a description of what to build and which topics it covers. You can use these projects to reinforce your learning and gain practical experience. Each project is designed to be doable over a weekend.
